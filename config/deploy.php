...
return [
    ...
    */
    ...
    'options' => [
        'application' => env('APP_NAME', 'Learn Online: LOL'),
        'repository' => 'http://oauth2:iU8CusES_h-8zHt5xuEK@gitlab.com/alpastechnology/this-is-not-e-learning',
    ...
    */
    ...
    'hosts' => [
        'globalconnectnepal.com' => [
            'stage' => 'production',
            'deploy_path' => '/var/www/globalconnectnepal.com',
            'user' => 'deployer',
        ...
        'dev.globalconnectnepal.com' => [
            'stage' => 'development',
            'deploy_path' => '/var/www/dev.globalconnectnepal.com',
            'user' => 'deployer',
            'identityFile' => '~/.ssh/id_rsa_gitlab',
            'forwardAgent' => true,
            'multiplexing' => true,
        ...
        'staging.globalconnectnepal.com' => [
            'stage' => 'staging',
            'deploy_path' => '/var/www/staging.globalconnectnepal.com',
            'user' => 'deployer',
            'identityFile' => '~/.ssh/id_rsa_gitlab',
            'forwardAgent' => true,
            'multiplexing' => true,
