...
<head>
    ...
    <link href="<?php echo e(global_asset('assets/css/pages/login/login-5.css')); ?>" rel="stylesheet" type="text/css" />
...
<body class="kt-page--loading-enabled kt-page--loading kt-header--fixed kt-header--minimize-topbar kt-header-mobile--fixed kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-subheader--enabled kt-subheader--transparent kt-page--loading">
    ...
    <script src="<?php echo e(global_asset('assets/js/pages/custom/login/login-general.js')); ?>" type="text/javascript"></script>
...
<!-- end::Body -->
</html><?php /**PATH E:\_CODING\_develop\tinel\resources\views/layouts/auth/app.blade.php ENDPATH**/ ?>