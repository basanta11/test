<section id="home">
        ...
        <div class="rev_slider" data-version="5.0">
          <ul>
            ...
            <!-- SLIDE 1 -->
              ...
              <li
            data-index="rs-<?php echo e($key); ?>"
                data-transition="slidingoverlayhorizontal"
                data-slotamount="default"
                data-easein="default"
                data-easeout="default"
                data-masterspeed="default"
                data-thumb="<?php echo e($banner['image']); ?>"
                data-rotate="0"
              ...
              >
                ...
                <div
                  ...
                  "
                >
                  <p style="white-space:pre-wrap; width:400px;" ><?php echo e($banner['description']); ?></p>
                </div>
            ...
            data-index="rs-1"
                ...
                data-easeout="default"
                data-masterspeed="default"
                data-thumb="<?php echo e(global_asset('assets/media/default-image.jpg')); ?>"
                data-rotate="0"
                data-saveperformance="off"
                data-title="Web Show"
                data-description=""
              >
                <!-- MAIN IMAGE -->
                <img
                  src="<?php echo e(global_asset('assets/media/default-image.jpg')); ?>"
                  alt=""
                  data-bgposition="center 10%"
                  data-bgfit="cover"
                  data-bgrepeat="no-repeat"
      ...
      <script>
        $(document).ready(function (e) {
          var revapi = $(".rev_slider").revolution({
            sliderType: "standard",
            jsFileLocation: "<?php echo e(global_asset('assets/frontend/js/revolution-slider/js/')); ?>",
            sliderLayout: "auto",
            dottedOverlay: "none",
            delay: 5000,
            navigation: {
  ...
  </section><?php /**PATH E:\_CODING\_develop\tinel\resources\views/frontend/render/home.blade.php ENDPATH**/ ?>