<div>
    <form class="kt-form" id="single-choice-form" enctype="multipart/form-data">
        @csrf
    ...
    <div class="modal-footer">
        ...
        <button id="single-choice-submit" form="single-choice-form" type="submit" class="btn btn-primary">{{ __("Submit") }}</button>
    </div>
</div>
