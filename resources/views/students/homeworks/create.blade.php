...
<div class="kt-container  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
		...
		<div class="kt-portlet__body kt-portlet__body--fit">
			<form class="kt-form" id="homework_form" method="POST" action="/my-homeworks">
                @csrf
                ...
                <div class="kt-portlet__body  py-0">
                    ...
                    <div class="form-group">
						<label>{{ __("Text") }}</label>
                        <textarea type="text" name="submission" id="submission" required class="form-control" placeholder="Enter submission"></textarea>
                    </div>
                </div>
            </form>
