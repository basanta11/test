						...
						<div class="kt-widget__content pl-0">
							<div class="kt-widget__head">
                                ...
                                <div class="kt-widget__action">
                                    <label>{{ __("Obtained Marks") }}:</label>
                                    {{ $homeworkUser->obtained_marks }}/{{ $homework->full_marks }}
            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
                <form>
                    ...
                    <div class="kt-portlet__body p-0 pb-4">
                        ...
                        <div class="form-group">
                            <label>{{ __("Text") }}</label>
                            <textarea type="text" name="submission" readonly id="submission" required class="form-control" placeholder="Enter submission">{{ $homeworkUser->answer }}</textarea>
                        </div>
                        <div class="tab-content py-3 px-0">
                            <div class="tab-pane active mobile" id="attachments-tab" role="tabpanel">
                ...
                <div class="kt-portlet__foot px-0 pt-4">
                    <div class="kt-form__actions">
                        <a href="/my-homeworks"><button type="button" class="btn btn-secondary">{{ __("Back") }}</button></a>
                    </div>
                </div>
