...
@include('layouts.partials.breadcrumbs', [
	...
	'crumbs' => [
		...
		[
			'name' => __("View Course"),
			'url' => '/student/assigned-courses/'.$set->test->lesson->course->id,
		],
		[
			'name' => 'View Test',
			'url' => '/tests-students/'.$set->test->lesson->course->id,
		],

		[
			'name' => 'View Result',
			'url' => '/tests-results/'.$set->test->lesson->course->id.'./index'
        ],
        [
			'name' => 'View Result Submission',
			'url' => url()->current(),
		],
	]
])
                            ...
                            <div class="kt-widget__top">
                                <div class="kt-widget__content pl-0">
                                    <div class="kt-widget__head"> 
                                        <span href="#" class="kt-widget__title">{{ $set['test']['lesson']['course']['title'] }}</span>
                                        
                                    </div>
                                    <div class="kt-widget__info">
                                        <div class="kt-widget__desc">
                                            <span>{{ __("Exam") }}: {{ $set['test']['title'] }}</span>
                                        </div>
                                    </div>
                                    <div class="kt-widget__info">
                                        <div class="kt-widget__desc">
                                    ...
                                    <div class="kt-widget__info">
                                        <div class="kt-widget__desc">
                                            <span>@if($set['test']['type']==0) Pre Test @else Post Test @endif</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="kt-widget__bottom">
                                <div class="kt-widget__item col ">
                                    <div class="kt-widget__details pl-0">
                                        ...
                                        <span class="kt-widget__value">{{ $set['test']['full_marks'] }}</span>
                                    </div>
                                </div>
                                <div class="kt-widget__item col ">
                                    <div class="kt-widget__details pl-0">
                                        <span class="kt-widget__title">P{{ __("ass Marks") }}</span>
                                        <span class="kt-widget__value">{{ $set['test']['pass_marks'] }}</span>
                                    </div>
                                </div>
                                <div class="kt-widget__item col ">
                                    <div class="kt-widget__details pl-0">
                            ...
                            <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v3__wrapper">
                                ...
                                <form class="kt-form" id="kt_form" >
                                    ...
                                    <div class="kt-form__actions">
                                        ...
                                        @endif
                                        <a  href="/tests-results" class="btn btn-success btn-md btn-tall btn-wide kt-font-bold kt-font-transform-u">
