    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="finishExamLabel">Finish test?</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                Are you sure you want to finish your test session?
            </div>
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-wrapper">
                                <div class="kt-portlet__head-actions">
                                    <span class="badge badge-primary">Full Marks: {{ $test->full_marks }}</span> &nbsp;
                                    <span class="badge badge-danger">Pass Marks: {{ $test->pass_marks }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="kt-portlet__body">
                        ...
                        <div class="kt-grid kt-wizard-v3 kt-wizard-v3--white" id="kt_wizard_v3" data-ktwizard-state="step-first">
                            ...
                            <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v3__wrapper" id="pointer-div">
                                ...
                                <form class="kt-form" id="kt_form" action="/test-finish" method="POST" enctype="multipart/form-data">
                                    @csrf

                                    <input type="hidden" name="test_set_id" value="{{ $set->id }}">
                                                    ...
                                                    <div class="kt-form__section kt-form__section--first">
                                                        <div class="kt-wizard-v3__form">
                                                            <div class="form-group text-center">
                                                                <a target="_blank" href="/test-start/download/{{ $question->id }}/{{ auth()->user()->id }}"><img src="{{ global_asset('assets/media/files/pdf.svg') }}" style="height: 150px; width: 100%;"> <button type="button" class="btn btn-warning align-center mt-3"> <i class="fa fa-download"></i> Download</button></a>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="custom-file">
                                                                    ...
                                                                    <input type="file" class="custom-file-input custom-file-rem" id="customFile" accept=
                                                                    "application/pdf, application/vnd.openxmlformats-officedocument.wordprocessingml.document" name="upload_answer" required>
                                                ...
                                                <div class="kt-wizard-v3__content" data-ktwizard-type="step-content" @if($loop->first) data-ktwizard-state="current" @endif>
                                                    ...
                                                    <div class="kt-form__section kt-form__section--first">
                                                        <div class="kt-wizard-v3__form">
                                                            ...
                                                            <div class="form-group">
                                                                @php $textans = $answers->where('test_question_id', $question->id); @endphp
                                                                <input 
                                                                    type="text" 
                                                                    class="form-control" 
                                                                    name="question-{{ $question->id }}"
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            $('#next-btn').on('click', function() {
                ...
                const url = "@php echo url('/tests/auto-save') @endphp";
                $.ajaxSetup({
                    headers: {
        ...
        $(document).on('click','.custom-remove-button',function(e){
            ...
            elem.parent().find('.custom-file-input').removeClass('is-invalid');
            $(this).remove();
        });
