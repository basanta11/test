...
<div class="kt-container  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body">
            <form class="kt-form mt-2" action="/update-image-upload/{{ $question->id }}" method="post" id="image-upload-form" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
...
<script>
    $(document).ready(function(){
        function removeFile(ty, fn,id=null) {
            var url= id == null ? '/questions/removeFile/'+ty+'/'+fn : '/questions/removeFileAndAttachment/'+ty+'/'+fn+'/'+id;
            $.ajax({
                url: url,
                type: 'GET'
            });
