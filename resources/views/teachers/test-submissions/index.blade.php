		...
		columns: [
			{
                ...
                template: function(row) {
                    return '<a href="/test-sets/'+row.set_id+'">'+row.set+'</a>';
                }
			},
				...
				template: function(data) {
					...
					<div class="dropdown">\
						...
						<div class="dropdown-menu dropdown-menu-right">\
							<a class="dropdown-item" href="/tests/submissions/'+data.id+'/show"><i class="la la-eye"></i> {{ __("View") }}</a>\
							<a class="dropdown-item" href="/tests/submissions/'+data.id+'/edit"><i class="la la-edit"></i> {{ __("Give Marks") }}</a>\
						</div>\
					</div>\
				';
				},
