                            ...
                            <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v3__wrapper">
                                ...
                                <form class="kt-form" id="kt_form" action="/tests/submission-finish/{{ $setuser->id }}" method="POST">
                                                    ...
                                                    <div class="kt-wizard-v3__form">
                                                        ...
                                                        @if(!$answers->isEmpty())
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control marks-input" min=0 disabled name="marks" value="{{ ($answers->first()->marks) ? $answers->first()->marks : 0 }}">
                                                            </div>
                                                        @else
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">Marks</label>
                                                                <input type="text" class="form-control marks-input" min=0 disabled name="marks" value="0">
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="kt-wizard-v3__content" data-ktwizard-type="step-content" @if($loop->first) data-ktwizard-state="current" @endif>
                                                    ...
                                                    <div class="kt-form__section kt-form__section--first">
                                                        <div class="kt-wizard-v3__form">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">Marks</label>
                                                                <input type="text" class="form-control marks-input" min=0 max={{ $question->marks }} name="marks-question-{{ $question->id }}" value="{{ !empty($formattedAnswers[$question->id]['marks']) ? $formattedAnswers[$question->id]['marks'] : 0 }}" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="kt-form__actions">
                                        ...
                                        @endif
                                        <a href="/tests/submissions/{{ $set->test_id }}" class="btn btn-success btn-md btn-tall btn-wide kt-font-bold kt-font-transform-u" data-ktwizard-type="action-submit">
