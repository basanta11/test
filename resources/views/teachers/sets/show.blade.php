...
@push('scripts')
    ...
    <script>
                    ...
                    template: function(data) {
                        ...
                        <div class="dropdown">\
                            ...
                            <div class="dropdown-menu dropdown-menu-right">\
                                <a class="dropdown-item" href="/questions/'+data.id+'/edit"><i class="la la-edit"></i> {{ __("Edit Question") }}</a>\
        ...
        $('#add-question-btn').on('click', function() {
            const url = "@php echo url('/api/sets/has-questions/'.$set->id) @endphp";
            ...
            switch (type) {
                case 'single-choice':
                    ...
                    if($('input[name="marks"]').length>0){
                        ...
                        const url = "@php echo url('/api/question/get-mark/'.$set->id) @endphp";
                        $.ajax({
                            url:url,
                            dataType:'JSON',
                            type:'GET',
                    ...
                    //         const url = "@php echo url('/questions/storeFile') @endphp";
                    ...
                    $('#single-choice-form').on('submit', function(e) {
                        ...
                        formData.append('set_id', {{$set->id}});

                        const url = "@php echo url('/store-single-choice') @endphp";
                ...
                case 'multi-choice':
                    ...
                    $('#multi-choice-form').on('submit', function(e) {
                        ...
                        const url = "@php echo url('/store-multi-choice') @endphp";
                ...
                case 'upload-pdf':
                    ...
                    $('#upload-pdf-form').on('submit', function(e) {
                        ...
                        const url = "@php echo url('/store-upload-pdf') @endphp";
                ...
                case 'image-upload':
                    ...
                    var _dropZone=new Dropzone(id,{
                        url: "@php echo url('/upload-dropzone') @endphp", // Set the url for your upload script location
                    ...
                    $(document).on('submit','#image-upload-form', function(e) {
                        ...
                        if(hasError.length>0){
                            ...
                            const url = "@php echo url('/store-image-upload') @endphp";
                ...
                case 'paragraph':
                    ...
                    $('#paragraph-form').on('submit', function(e) {
                        ...
                        const url = "@php echo url('/store-paragraph') @endphp";
                ...
                case 'text':
                    ...
                    $('#text-form').on('submit', function(e) {
                        ...
                        const url = "@php echo url('/store-text') @endphp";
        ...
        function removeFile(ty, fn) {
            $.ajax({
                url: '/questions/removeFile/'+ty+'/'+fn,
                type: 'GET'
            });
