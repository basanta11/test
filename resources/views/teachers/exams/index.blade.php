    ...
    var datatable = $('.kt-datatable').KTDatatable({
		...
		columns: [
			...
			},
			{
				...
				{
					return `<a href="/exam-teachers/${data.id}"><span>${data.title}</span></a>`
				}
			},
				...
				template: function(data) {
					...
					<div class="dropdown">\
						...
						<div class="dropdown-menu dropdown-menu-right">\
							<a class="dropdown-item" href="/exam-teachers/'+data.id+'"><i class="la la-eye"></i> View</a>\
							<a class="dropdown-item" href="/submissions/'+data.id+'"><i class="la la-folder"></i> View Submissions</a>\
						</div>\
					</div>\
				';
				},
