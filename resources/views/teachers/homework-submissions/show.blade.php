		...
		<div class="kt-portlet__body py-0">
            <form action="/homework-submissions/{{ $homeworkUser->id  }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="obtained_marks" readonly value="{{ $homeworkUser->obtained_marks }}" class="form-control">
                </div>
                <div class="kt-portlet__foot px-0 pt-4">
                    <div class="kt-form__actions">
                        <a href="/homework-submissions/{{ $homeworkUser->homework_id }}"><button type="button" class="btn btn-secondary">{{ __("Back") }}</button></a>
                    </div>
                </div>
            </form>
        </div>
