            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
						...
						<a href="/homeworks/create" class="btn btn-brand btn-elevate btn-icon-sm">
...
<script>
				...
				template: function(data) {
					...
					<div class="dropdown">\
						...
						<div class="dropdown-menu dropdown-menu-right">\
							<a class="dropdown-item" href="/homeworks/'+data.id+'/edit"><i class="la la-edit"></i> Edit</a>\
							<a class="dropdown-item" href="/homework-submissions/'+data.id+'"><i class="la la-folder"></i> View Submissions</a>\
							<a class="dropdown-item item-delete" data-id="'+data.id+'" href="#"><i class="la la-trash"></i> Delete</a>\
						</div>\
					</div>\
				';
				},
	...
	$(document).on('click','.item-delete',function(e){
		...
		var id=$(this).data('id');
        link=`/homeworks/${id}`;
        message="Do you really want to delete this homework?";
