...
@include('layouts.partials.breadcrumbs', [
	...
	'crumbs' => [
        ...
        [
            'name'=> __("Create Virtual Classroom"),
            'url'=> url()->current(),
        ]
	]
])
		...
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
				<h3 class="kt-portlet__head-title">
					{{ __("Create Virtual Classroom") }}
				</h3>
			</div>
			
		</div>
        <div class="kt-portlet__body">
            <form class="kt-form" method="POST" action="/meetings">
                @csrf
                <div class="kt-portlet__body p-0 pb-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-12">
                            <div class="input-daterange input-group row" id="kt_datepicker_5">     
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" name="start_date" placeholder="{{ __("Select start date") }}">
                                </div>
                                {{-- <span class="input-group-text px-1"><i class="la la-ellipsis-h"></i></span> --}}
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" name="end_date" placeholder="{{ __("Select end date") }}">
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="input-daterange input-group row" > 
                                    <div class="col-lg-6">    
                                        <input class="form-control" id="kt_timepicker_1" name="start_time" readonly="" placeholder="{{ __("Select start time") }}" type="text">
                                    </div>
                                    {{-- <span class="input-group-text px-1"><i class="la la-ellipsis-h"></i></span> --}}
                                    <div class="col-lg-6">
                                        <input class="form-control " id="kt_timepicker_2" name="end_time" readonly="" placeholder="{{ __("Select end time") }}" type="text">
                                    </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group mt-4">
                        ...
                        <input type="text" name="password" class="form-control" placeholder="{{ __("Enter password for the virtual classroom") }}">
                    </div>
