				...
				<div class="kt-portlet__head-toolbar">
					<div class="kt-portlet__head-wrapper">
						<div class="kt-portlet__head-actions">
							...
							<a href="/administrators/create" class="btn btn-brand btn-elevate btn-icon-sm">
...
<script>
	...
	let dataJSONArray = @json($administrators);
    var options = {
						...
						<div class="dropdown">\
							<a href="javascript:;" class="btn btn-sm btn-clean btn-icon btn-icon-md" data-toggle="dropdown">\
						  	...
						  	<div class="dropdown-menu dropdown-menu-right">\
						    	<a class="dropdown-item" href="/administrators/'+data.id+'"><i class="la la-eye"></i> {{ __("View") }}</a>\
						    	<a class="dropdown-item" href="/administrators/'+data.id+'/edit"><i class="la la-edit"></i> {{ __("Edit Details") }}</a>\
						    	'+status+'\
						  	</div>\
						</div>\
					';
		...
		$(document).on('click','.custom-activate', function() {
			...
			link=`/administrators/change-status-bulk/1`;
		...
		$(document).on('click','.custom-deactivate', function() {
			...
			link=`/administrators/change-status-bulk/2`;
