...
<div class="kt-container  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body">
            <form class="kt-form" method="POST" action="/classrooms">
                @csrf
                ...
                <div class="kt-portlet__body p-0 pb-4">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" cols="30" class="form-control" rows="10" placeholder="{{ __("Enter description") }}"></textarea>
                    </div>
                    <div class="form-group">
                        <label>{{ __("Section") }}</label><br>
                        <input type="text" name="sections" data-role="tagsinput" id="sections" placeholder="{{ __("Press enter to add another section") }}...">
                    </div>
                </div>
