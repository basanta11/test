            ...
            <form class="kt-form" method="POST" action="/classrooms">
                ...
                <div class="kt-portlet__body p-0 pb-4">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" cols="30" class="form-control" rows="10" placeholder="Enter description"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Section Names</label><br>
                        <input type="text" name="sections" data-role="tagsinput" id="sections" placeholder="Press enter to add another section...">
                    </div>
                </div>
