            ...
            <form class="kt-form" method="POST" action="/courses" enctype="multipart/form-data">
                ...
                <div class="kt-portlet__body p-0 pb-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number"  name="credit_hours" class="form-control" placeholder="{{ __("Enter credit hours") }}">
                    </div>
                    <div class="form-group">
                        <label>{{ __("Learning Outcome") }}</label>
                        <textarea name="learn_what" class="form-control" placeholder="{{ __("Enter learning outcome") }}"></textarea>
                    </div>
                    <div class="form-group">
