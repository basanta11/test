...
<div class="kt-container  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body">
            <form class="kt-form" method="POST" action="/behaviour-types/{{ $behaviourType->id }}">
                @csrf
                @method('PATCH')
                <div class="kt-portlet__body p-0 pb-4">
                    <div class="form-group ">
                        <label>Title</label>
                        <input class="form-control" value="{{ $behaviourType->title }}" name="title" placeholder="Enter Title" required>
                    </div>
                </div>
