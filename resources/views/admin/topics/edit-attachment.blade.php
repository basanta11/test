...
<div class="kt-container  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body">
            <form class="kt-form" method="POST" action="/topics/attachments/{{ $attachment->id }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="kt-portlet__body p-0 pb-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" value="{{ $attachment->title }}" placeholder="Enter title">
                    </div>
                    <div class="form-group">
                        <label>{{ __("Attachments") }}</label>
                        <div class="kt-form__control">
                            <div class="custom-file">
                                <input type="file" accept="image/* , video/*, audio/*, .pdf, .doc, .docx" name="attachment" class="custom-file-input custom-file-rem input-attach">
