...
!(function (a, b) {
    ...
    var b = (function () {
        ...
        d = (function () {
            ...
            function e(a) {
                return function (d) {
                    return (
                        (d = b.isArray(d) ? d : [].slice.call(arguments, 0)),
                        function (e) {
                            var f = [];
                            return (
                                b.each(d, function (c) {
                ...
                b.mixin(c.prototype, {
                    set: function (b, c) {
                        ...
                        this.size >= this.maxSize && (this.list.remove(d), delete this.hash[d.key], this.size--),
                            (f = this.hash[b]) ? ((f.val = c), this.list.moveToFront(f)) : ((f = new e(b, c)), this.list.add(f), (this.hash[b] = f), this.size++);
                    },
                    get: function (b) {
                        var c = this.hash[b];
        ...
        g = (function () {
            ...
            function g(a) {
                (a = a || {}),
                    ...
                    (this._cache = !1 === a.cache ? new e(0) : f);
            }
            var c = 0,
                d = {},
                f = new e(10);
            return (
                (g.setMaxPendingRequests = function (b) {
                    this.maxPendingRequests = b;
                }),
                ...
                b.mixin(g.prototype, {
                    ...
                    _get: function (a, b) {
                        function h(a) {
                            b(null, a), e._cache.set(f, a);
                        }
                        function i() {
                            b(!0);
                        }
                        function j() {
                            c--, delete d[f], e.onDeckRequestArgs && (e._get.apply(e, e.onDeckRequestArgs), (e.onDeckRequestArgs = null));
                        }
                        var f,
                            g,
                            e = this;
                        (f = this._fingerprint(a)),
                            this.cancelled ||
                                f !== this.lastReq ||
                                ((g = d[f]) ? g.done(h).fail(i) : c < this.maxPendingRequests ? (c++, (d[f] = this._send(a).done(h).fail(i).always(j))) : (this.onDeckRequestArgs = [].slice.call(arguments, 0)));
                    },
                    get: function (c, d) {
                        var e, f;
                ...
                b.mixin(e.prototype, {
                    ...
                    add: function (a) {
                        ...
                        (a = b.isArray(a) ? a : [a]),
                            b.each(a, function (a) {
                                var h, i;
                                (e.datums[(h = e.identify(a))] = a),
                                    (i = f(e.datumTokenizer(a))),
                                    b.each(i, function (a) {
                                        var b, f, i;
                    ...
                    search: function (e) {
                        var j,
                            ...
                            g = this;
                        return (
                            (j = f(this.queryTokenizer(e))),
                            b.each(j, function (a) {
                                var b, e, f, h;
                                if (k && 0 === k.length && !g.matchAnyQueryToken) return !1;
                                for (b = g.trie, e = a.split(""); b && (f = e.shift()); ) b = b[c][f];
                                if (b && 0 === e.length) (h = b[d].slice(0)), (k = k ? i(k, h) : h);
                                else if (!g.matchAnyQueryToken) return (k = []), !1;
                            }),
                            k
                                ? b.map(h(k), function (a) {
                                      return g.datums[a];
                                  })
                                : []
                        );
        ...
        i = (function () {
            ...
            var a;
            return (
                (a = { data: "data", protocol: "protocol", thumbprint: "thumbprint" }),
                b.mixin(c.prototype, {
                    _settings: function () {
                    ...
                    fromCache: function () {
                        var d,
                            c = {};
                        return this.cache
                            ? ((c.data = this.storage.get(a.data)),
                              (c.protocol = this.storage.get(a.protocol)),
                              (c.thumbprint = this.storage.get(a.thumbprint)),
                              (d = c.thumbprint !== this.thumbprint || c.protocol !== location.protocol),
                              c.data && !d ? c.data : null)
                            : null;
                    },
        ...
        j = (function () {
            ...
            function a(a) {
                (this.url = a.url),
                    ...
                    (this.transport = new g({ cache: a.cache, limiter: a.limiter, transport: a.transport, maxPendingRequests: a.maxPendingRequests }));
            }
            return (
                b.mixin(a.prototype, {
                    _settings: function () {
        ...
        k = (function () {
            ...
            function f(a) {
                ...
                var b, c, d;
                return (b = a.prepare), (c = a.replace), (d = a.wildcard), b || (b = c ? e : a.wildcard ? f : g);
            }
            function g(a) {
                function f(a) {
                    return function (d) {
            ...
            return function (f) {
                var g, h;
                return (
                    (g = { initialize: !0, identify: b.stringify, datumTokenizer: null, queryTokenizer: null, matchAnyQueryToken: !1, sufficient: 5, indexRemote: !1, sorter: null, local: [], prefetch: null, remote: null }),
                    (f = b.mixin(g, f || {})),
                    !f.datumTokenizer && a.error("datumTokenizer is required"),
                    !f.queryTokenizer && a.error("queryTokenizer is required"),
                    (h = f.sorter),
                    (f.sorter = h
                        ? function (a) {
                              return a.sort(h);
        ...
        return (
            ...
            b.mixin(e.prototype, {
                ...
                _loadPrefetch: function () {
                    function f(a, b) {
                        if (a) return d.reject();
                        c.add(b), c.prefetch.store(c.index.serialize()), d.resolve();
                    }
                    var d,
                        e,
                        c = this;
                ...
                search: function (c, d, e) {
                    ...
                    return (
                        (d = d || b.noop),
                        (e = e || b.noop),
                        (g = this.sorter(this.index.search(c))),
                        d(this.remote ? g.slice() : g),
                        this.remote && g.length < this.sufficient ? this.remote.get(c, h) : this.remote && this.remote.cancelLastRequest(),
                        this
                    );
                },
                all: function () {
    ...
    (function (a, b) {
        ...
        var b = (function () {
            ...
            c = (function () {
                ...
                function c(c) {
                    ...
                    return (
                        (h = b.mixin({}, a, c)),
                        (g = { css: f(), classes: h, html: d(h), selectors: e(h) }),
                        {
                            css: g.css,
                            html: g.html,
                            classes: g.classes,
            ...
            d = (function () {
                ...
                return (
                    (c = "typeahead:"),
                    (d = { render: "rendered", cursorchange: "cursorchanged", select: "selected", autocomplete: "autocompleted" }),
                    b.mixin(e.prototype, {
                        _trigger: function (b, d) {
                            var e = a.Event(c + b);
                            return this.$el.trigger.call(this.$el, e, d || []), e;
                        },
                        before: function (a) {
                            var b, c;
            ...
            e = (function () {
                ...
                function c(b, c, d, e) {
                    var f;
                    if (!d) return this;
                    for (c = c.split(a), d = e ? j(d, e) : d, this._callbacks = this._callbacks || {}; (f = c.shift()); ) (this._callbacks[f] = this._callbacks[f] || { sync: [], async: [] }), this._callbacks[f][b].push(d);
                    return this;
                }
                function d(a, b, d) {
            ...
            f = (function (a) {
                "use strict";
                function e(a) {
                    return d[a.toUpperCase()] || a;
                }
                function f(a, c, d, f) {
                    for (var h, g = [], i = 0, j = a.length; i < j; i++) {
                        var k = b.escapeRegExChars(a[i]);
                        f && (k = k.replace(/\S/g, e)), g.push(k);
                    }
                    return (h = d ? "\\b(" + g.join("|") + ")\\b" : "(" + g.join("|") + ")"), c ? new RegExp(h) : new RegExp(h, "i");
                }
                var c = { node: null, pattern: null, tagName: "strong", className: null, wordsOnly: !1, caseSensitive: !1, diacriticInsensitive: !1 },
                    d = {
                ...
                return function (e) {
                    ...
                    var g;
                    (e = b.mixin({}, c, e)), e.node && e.pattern && ((e.pattern = b.isArray(e.pattern) ? e.pattern : [e.pattern]), (g = f(e.pattern, e.caseSensitive, e.wordsOnly, e.diacriticInsensitive)), i(e.node, h));
                };
            })(window.document),
            g = (function () {
                "use strict";
                function d(c, d) {
                    (c = c || {}),
                        ...
                        a(d.menu).attr("id", this.$input.attr("id") + "_listbox"),
                ...
                return (
                    ...
                    b.mixin(d.prototype, e, {
                        ...
                        _updateDescendent: function (b, c) {
                            this.$input.attr("aria-activedescendant", c);
                        },
                        bind: function () {
                            var d,
                                e,
                                ...
                                a = this;
                            return (
                                (d = b.bind(this._onBlur, this)),
                                (e = b.bind(this._onFocus, this)),
                                (f = b.bind(this._onKeydown, this)),
                                (g = b.bind(this._onInput, this)),
                                this.$input.on("blur.tt", d).on("focus.tt", e).on("keydown.tt", f),
                                !b.isMsie() || b.isMsie() > 9
                                    ? this.$input.on("input.tt", g)
                                    : this.$input.on("keydown.tt keypress.tt cut.tt paste.tt", function (d) {
                        ...
                        clearHintIfInvalid: function () {
                            var b, c, d, e;
                            (b = this.getInputValue()), (c = this.getHint()), (d = b !== c && 0 === c.indexOf(b)), !(e = "" !== b && d && !this.hasOverflow()) && this.clearHint();
                        },
                        hasFocus: function () {
            ...
            h = (function () {
                ...
                function g(c, e) {
                    (c = c || {}),
                        ...
                        c.name && !j(c.name) && a.error("invalid dataset name: " + c.name),
                        e.mixin(this),
                        (this.highlight = !!c.highlight),
                        (this.name = b.toStr(c.name || d())),
                        (this.limit = c.limit || 5),
                        (this.displayFn = h(c.display || c.displayKey)),
                        (this.templates = i(c.templates, this.displayFn)),
                ...
                var c, d;
                return (
                    (c = { dataset: "tt-selectable-dataset", val: "tt-selectable-display", obj: "tt-selectable-object" }),
                    (d = b.getIdGenerator()),
                    (g.extractData = function (d) {
                        var e = a(d);
                        return e.data(c.obj) ? { dataset: e.data(c.dataset) || "", val: e.data(c.val) || "", obj: e.data(c.obj) || null } : null;
                    }),
                    b.mixin(g.prototype, e, {
                        _overwrite: function (b, c) {
                            (c = c || []),
                                c.length ? this._renderSuggestions(b, c) : this.async && this.templates.pending ? this._renderPending(b) : !this.async && this.templates.notFound ? this._renderNotFound(b) : this._empty(),
                                this.trigger("rendered", c, !1, this.name);
                        },
                        _append: function (b, c) {
                            (c = c || []),
                                c.length && this.$lastSuggestion.length ? this._appendSuggestions(b, c) : c.length ? this._renderSuggestions(b, c) : !this.$lastSuggestion.length && this.templates.notFound && this._renderNotFound(b),
                                this.trigger("rendered", c, !0, this.name);
                        },
                        ...
                        _getSuggestionsFragment: function (e, g) {
                            ...
                            return (
                                ...
                                b.each(g, function (d) {
                                    var f, g;
                                    (g = h._injectQuery(e, d)),
                                        (f = a(h.templates.suggestion(g))
                                            .data(c.dataset, h.name)
                                            .data(c.obj, d)
                                            .data(c.val, h.displayFn(d))
                                            .addClass(h.classes.suggestion + " " + h.classes.selectable)),
                                        i.appendChild(f[0]);
                                }),
                                this.highlight && f({ className: this.classes.highlight, node: i, pattern: e }),
                                a(i)
                            );
                        },
                        _getFooter: function (b, c) {
                            return this.templates.footer ? this.templates.footer({ query: b, suggestions: c, dataset: this.name }) : null;
                        },
                        _getHeader: function (b, c) {
                            return this.templates.header ? this.templates.header({ query: b, suggestions: c, dataset: this.name }) : null;
                        },
                        ...
                        update: function (c) {
                            function h(a) {
                                f || ((f = !0), (a = (a || []).slice(0, d.limit)), (g = a.length), d._overwrite(c, a), g < d.limit && d.async && d.trigger("asyncRequested", c, d.name));
                            }
                            function i(b) {
                                if (((b = b || []), !e && g < d.limit)) {
                                    d.cancel = a.noop;
                                    var f = Math.abs(g - d.limit);
                                    (g += f), d._append(c, b.slice(0, f)), d.async && d.trigger("asyncReceived", c, d.name);
                                }
                            }
                            var d = this,
                                e = !1,
                            ...
                            this.cancel(),
                                (this.cancel = function () {
                                    (e = !0), (d.cancel = a.noop), d.async && d.trigger("asyncCanceled", c, d.name);
                                }),
                                this.source(c, h, i),
                                !f && h([]);
                        },
                    ...
                    b.mixin(c.prototype, e, {
                        ...
                        _allDatasetsEmpty: function () {
                            return b.every(
                                ...
                                b.bind(function (b) {
                                    var c = b.isEmpty();
                                    return this.$node.attr("aria-expanded", !c), c;
                                }, this)
                            );
                        },
                        ...
                        _ensureVisible: function (b) {
                            ...
                            (c = b.position().top),
                                ...
                                (f = this.$node.height() + parseInt(this.$node.css("paddingTop"), 10) + parseInt(this.$node.css("paddingBottom"), 10)),
                                c < 0 ? this.$node.scrollTop(e + c) : f < d && this.$node.scrollTop(e + (d - f));
                        },
                        bind: function () {
                            var d,
                                c = this;
                            return (
                                (d = b.bind(this._onSelectableClick, this)),
                                this.$node.on("click.tt", this.selectors.selectable, d),
                        ...
                        selectableRelativeToCursor: function (b) {
                            var c, d, e, f;
                            return (d = this.getActiveSelectable()), (c = this._getSelectables()), (e = d ? c.index(d) : -1), (f = e + b), (f = ((f + 1) % (c.length + 1)) - 1), (f = f < -1 ? c.length - 1 : f), -1 === f ? null : c.eq(f);
                        },
                ...
                return (
                    b.mixin(c.prototype, {
                        update: function (b, c) {
                            var e,
                                d = c.length;
                            (e = 1 === d ? { result: "result", is: "is" } : { result: "results", is: "are" }), this.$el.text(d + " " + e.result + " " + e.is + " available, use up and down arrow keys to navigate.");
                        },
                        cleared: function () {
                            this.$el.text("");
                        },
            ...
            k = (function () {
                ...
                var a = i.prototype;
                return (
                    b.mixin(c.prototype, i.prototype, {
                        open: function () {
            ...
            l = (function () {
                ...
                return (
                    b.mixin(c.prototype, {
                        _hacks: function () {
                            var d, e;
                            (d = this.input.$input || a("<div>")),
                                (e = this.menu.$node || a("<div>")),
                                d.on("blur.tt", function (a) {
                                    var c, f, g;
                        ...
                        _onDatasetRendered: function (b, c, d, e) {
                            this._updateHint(), this.eventBus.trigger("render", c, d, e);
                        },
                        ...
                        _onEnterKeyed: function (b, c) {
                            var d;
                            (d = this.menu.getActiveSelectable()) && this.select(d) && (c.preventDefault(), c.stopPropagation());
                        },
                        ...
                        _updateHint: function () {
                            ...
                            (c = this.menu.getTopSelectable()),
                                ...
                                !d || b.isBlankString(e) || this.input.hasOverflow()
                                    ? this.input.clearHint()
                                    : ((f = g.normalizeQuery(e)), (h = b.escapeRegExChars(f)), (i = new RegExp("^(?:" + h + ")(.+$)", "i")), (j = i.exec(d.val)) && this.input.setHint(e + j[1]));
                        },
                        isEnabled: function () {
                            return this.enabled;
                        },
                        ...
                        select: function (b) {
                            ...
                            return !(!c || this.eventBus.before("select", c.obj, c.dataset)) && (this.input.setQuery(c.val, !0), this.eventBus.trigger("select", c.obj, c.dataset), this.close(), !0);
                        },
                        autocomplete: function (b) {
                            var c, d;
                            return (
                                (c = this.input.getQuery()),
                                (d = this.menu.getSelectableData(b)),
                                !(!(d && c !== d.val) || this.eventBus.before("autocomplete", d.obj, d.dataset)) && (this.input.setQuery(d.val), this.eventBus.trigger("autocomplete", d.obj, d.dataset), !0)
                            );
                        },
                        moveCursor: function (b) {
                            ...
                            return (
                                (c = this.input.getQuery()),
                                (d = this.menu.selectableRelativeToCursor(b)),
                                (e = this.menu.getSelectableData(d)),
                                (f = e ? e.obj : null),
                                (g = e ? e.dataset : null),
                                (i = d ? d.attr("id") : null),
                                this.input.trigger("cursorchange", i),
                                !(this._minLengthMet() && this.menu.update(c)) &&
                                    !this.eventBus.before("cursorchange", f, g) &&
                                    (this.menu.setCursor(d), e ? this.input.setInputValue(e.val) : (this.input.resetInputValue(), this._updateHint()), this.eventBus.trigger("cursorchange", f, g), !0)
                            );
                        },
                        destroy: function () {
        ...
        !(function () {
            ...
            function n(a, b) {
                return a.clone().addClass(b.classes.hint).removeData().css(b.css.hint).css(p(a)).prop("readonly", !0).removeAttr("id name placeholder required").attr({ spellcheck: "false", tabindex: -1 });
            }
            function o(a, b) {
                a.data(f.attrs, { dir: a.attr("dir"), autocomplete: a.attr("autocomplete"), spellcheck: a.attr("spellcheck"), style: a.attr("style") }), a.addClass(b.classes.input).attr({ spellcheck: !1 });
                try {
            ...
            function q(a) {
                ...
                (c = a.data(f.www)),
                    ...
                    b.each(a.data(f.attrs), function (c, d) {
                        b.isUndefined(c) ? a.removeAttr(d) : a.attr(d, c);
                    }),
                    a.removeData(f.typeahead).removeData(f.www).removeData(f.attr).removeClass(c.classes.input),
            ...
            var e, f, h;
            (e = a.fn.typeahead),
                (f = { www: "tt-www", attrs: "tt-attrs", typeahead: "tt-typeahead" }),
                (h = {
                    initialize: function (h, m) {
                        function q() {
                            var c, e, q, s, t, u, v, w, x, z, A;
                            b.each(m, function (a) {
                                ...
                                (A = u ? k : i),
                                (v = new d({ el: c })),
                                (w = new g({ hint: q, input: c }, p)),
                                (x = new A({ node: s, datasets: m }, p)),
                                new j({ $input: c, menu: x }),
                                (z = new l({ input: w, menu: x, eventBus: v, minLength: h.minLength }, p)),
                                c.data(f.www, p),
                                c.data(f.typeahead, z);
                        }
                        var p;
                        return (m = b.isArray(m) ? m : [].slice.call(arguments, 1)), (h = h || {}), (p = c(h.classNames)), this.each(q);
                    },
                    isEnabled: function () {
                        var b;
                        return (
                            m(this.first(), function (a) {
                                b = a.isEnabled();
                            }),
                            b
                        );
