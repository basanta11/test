...
($.Thailand = function (e) {
    ...
    var t = function (e) {
            var t,
                ...
                i = [];
            return (
                e.lookup && e.words && ((a = e.lookup.split("|")), (n = e.words.split("|")), (e = e.data)),
                (t = function (e) {
                    return (
                ...
                e.map(function (e) {
                    ...
                    3 === e.length && (a = 2),
                        e[a].map(function (n) {
                            n[a].map(function (o) {
                                (o[a] = o[a] instanceof Array ? o[a] : [o[a]]),
                                    o[a].map(function (r) {
                                        var c = { district: t(o[0]), amphoe: t(n[0]), province: t(e[0]), zipcode: r, full_address: `${t(o[0])} , ${t(n[0])}, ${t(e[0])}. ${r}` };
        ...
        a = function (e, t, n) {
            ...
            return (
                (c = d) && (s && p && (c += a(e.substr(0, p), t.substr(0, p), !1)), s + d < h && p + d < l && (c += a(e.substr(s + d, h - s - d), t.substr(p + d, l - p - d), !1))),
                !1 === n ? c : e === t ? 100 : h > l ? Math.floor((c / h) * 100) : Math.floor((c / l) * 100)
            );
        };
    !(function (a) {
        var n,
            i = e.database_type.toLowerCase();
        switch (("json" !== i && "zip" !== i && (i = e.database.split(".").pop()), i)) {
            ...
            case "zip":
                e.zip_worker_path ||
                    ...
                    ((n = new XMLHttpRequest()).responseType = "blob"),
                ...
                { hint: !0, highlight: !0, minLength: 2 },
                {
                    ...
                    source: function (e, n) {
                        ...
                        try {
                            i = new JQL(
                                i
                                    .concat(t.select("*").where("zipcode").match(e).fetch())
                                    .concat(t.select("*").where("province").match(e).fetch())
                                    .concat(t.select("*").where("amphoe").match(e).fetch())
                                    .concat(t.select("*").where("district").match(e).fetch())
                                    .map(function (e) {
                                    ...
                                    .map(function (t) {
                                        return (
                                            (t = JSON.parse(t)),
                                            (t.likely = [5 * a(e, t.district), 3 * a(e, t.amphoe.replace(/^เมือง/, "")), a(e, t.province), a(e, t.zipcode)].reduce(function (e, t) {
                                                return Math.max(e, t);
                                            })),
                                            t
                                        );
        ...
        for (n in e)
            n.indexOf("$") > -1 &&
                ...
                e[n] &&
                e[n]
                    .bind("typeahead:select typeahead:autocomplete", function (t, a) {
